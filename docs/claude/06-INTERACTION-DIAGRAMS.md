---
title: "Interaction Diagrams: Newo SuperAgent System"
---
...
graph TB
    ...
    style ConvoAgent fill:#e1f5fe
    style TaskManager fill:#f3e5f5
    style Workers fill:#fff3e0
    style ExternalSystems fill:#f1f8e9
```
...
graph LR
    ...
    style EventQueue fill:#ffecb3
    style EventRouter fill:#e8f5e8
```
...
graph TB
    ...
    style TaskManager fill:#f3e5f5
    style WorkerSelection fill:#fff3e0
...
graph TB
    ...
    SMSOut --> SmsWorker
    EmailOut --> EmailWorker
    
    style ConvoAgent fill:#e1f5fe
    style ChannelDetection fill:#fff3e0
    style ProcessLogic fill:#e8f5e8
```
...
graph TD
    ...
    style GeneralManagerAgent fill:#f3e5f5
    style IndustrySelection fill:#fff3e0
    style DeployConfig fill:#e8f5e8
```
...
graph LR
    ...
    style UserState fill:#ffecb3
    style SessionState fill:#e1f5fe
    style SystemState fill:#f1f8e9
```
...
graph TB
    ...
    style IntegrationWorkers fill:#fff3e0
    style ResponseProcessing fill:#e8f5e8
```
